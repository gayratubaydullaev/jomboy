-- MyShopUZ: single consolidated schema migration (replaces former init + hardening + patches)
-- Fresh DB: pnpm exec prisma migrate deploy
-- Existing DB with old migration history: reset DB or baseline — see prisma/MIGRATIONS.md

-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('BUYER', 'SELLER', 'ADMIN', 'ADMIN_MODERATOR');
...
CREATE TABLE "platform_settings" (
    ...
    "chat_with_seller_enabled" BOOLEAN NOT NULL DEFAULT true,
...
-- CreateIndex
CREATE INDEX "products_is_active_is_moderated_idx" ON "products"("is_active", "is_moderated");
...
-- CreateIndex
CREATE UNIQUE INDEX "orders_guest_view_token_key" ON "orders"("guest_view_token");
...
-- CreateIndex
CREATE INDEX "orders_order_number_guest_phone_idx" ON "orders"("order_number", "guest_phone");

-- CreateIndex
CREATE UNIQUE INDEX "checkout_sessions_poll_token_key" ON "checkout_sessions"("poll_token");

-- CreateIndex
CREATE INDEX "checkout_sessions_buyer_id_idx" ON "checkout_sessions"("buyer_id");

-- CreateIndex
CREATE INDEX "checkout_sessions_cart_session_id_idx" ON "checkout_sessions"("cart_session_id");
...
-- CreateIndex
CREATE INDEX "payme_transactions_account_order_id_idx" ON "payme_transactions"("account_order_id");

-- CreateIndex
CREATE INDEX "payme_transactions_create_time_idx" ON "payme_transactions"("create_time");
