  ...
  return (
    <div className="flex flex-col gap-4 md:flex-row md:flex-wrap md:gap-4 md:items-end">
      ...
      <div className="w-full md:w-auto md:min-w-[140px]">
        <label className="text-xs text-muted-foreground block mb-1.5">{t('catalog.filterCategory')}</label>
        <select
      ...
      <div className="w-full md:w-auto">
        <label className="text-xs text-muted-foreground block mb-1.5">{t('catalog.filterPrice')}</label>
        <div className="flex gap-2 items-center">
          <Input
            type="number"
            min={0}
            placeholder={t('catalog.placeholderMin')}
          ...
          <Input
            type="number"
            min={0}
            placeholder={t('catalog.placeholderMax')}
            className="flex-1 min-w-0 h-11 text-sm md:w-24 md:flex-none"
            value={maxPrice}
      ...
      {/* 3. Saralash */}
      <div className="w-full md:w-auto">
        <label className="text-xs text-muted-foreground block mb-1.5">{t('catalog.sortLabel')}</label>
        <select
        ...
        >
          {searchFromUrl.trim() && <option value="relevance">{t('catalog.sortRelevance')}</option>}
          <option value="createdAt">{t('catalog.sortNew')}</option>
