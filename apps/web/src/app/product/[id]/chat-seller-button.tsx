  ...
  return (
    <div className="flex flex-col gap-1">
      <Button
        ...
        title={!chatEnabled ? t('product.chatDisabledTitle') : undefined}
      >
        {chatEnabled ? (
        ...
        {chatEnabled ? t('product.chatWriteSeller') : t('product.chatOff')}
      </Button>
      {!chatEnabled && <p className="text-[10px] text-muted-foreground">{t('product.chatSellerOffHint')}</p>}
    </div>
  );
}
