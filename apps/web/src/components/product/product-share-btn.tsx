...
export function ProductShareBtn({
  ...
  const titleCopied = t('share.linkCopied');
  const titleShare = t('share.shareTitle', { productName });
  const ariaCopied = titleCopied;
  const ariaCopy = t('share.ariaCopy', { productName });
  ...
  return (
    <Button
      ...
      title={copied ? titleCopied : titleShare}
